...
import com.gmail.llemaxiss.security.components.csrf.CustomCsrfRepository;
...
/**
 * AppConfigByAuthManagerWithCustomUserDetailsAndCustomFilterAndCustomCsrf
 */
@EnableWebSecurity(debug = true)
@Configuration
public class ACBAMWCUDACFACC {
	@Bean
